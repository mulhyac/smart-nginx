//package com.zejor.devops.nginx.manager;
//
//import com.zejor.devops.nginx.conf.Configure;
//import com.zejor.devops.nginx.exception.NginxServiceManagerException;
//import org.slf4j.Logger;
//import org.slf4j.LoggerFactory;
//import org.springframework.stereotype.Component;
//
//import com.zejor.devops.nginx.common.CMDUtil;
//import com.zejor.devops.nginx.common.CommonFields;
//import com.zejor.devops.nginx.core.thread.SystemProcessManager;
//
///**
// * Nginx操作类
// * @Project : nginx
// * @Program Name : NginxManager
// * @Description :
// * @Author : 郭胜凯
...
//   */
//  public void stop() {
//    String excuse = CMDUtil.excuse(CommonFields.NGINX + " -s stop", Configure.getNginxPath());
...
//      @Override
//      public void run() {
//        String excuse = CMDUtil.excuse(CommonFields.NGINX + " -c " + Configure.getNginxConfPath()
//                .replace(" ", "\" \""), Configure.getNginxPath());
//        if (!"".equals(excuse.trim())) {
...
//    }
//    //校验
//    String check = CMDUtil.excuse(CommonFields.NGINX + " -t -c " + Configure.getNginxConfPath(), Configure.getNginxPath());
//    if (check.indexOf(CommonFields.NGINX  + ": configuration file " + Configure.getNginxConfPath() + " test is successful") == -1) {
//    		throw new NginxServiceManagerException("Nginx配置文件校验失败:" + check);
//	}
//    //重加载
//    String excuse = CMDUtil.excuse(CommonFields.NGINX + " -s reload -c " + Configure.getNginxConfPath(), Configure.getNginxPath());
